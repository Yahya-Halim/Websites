...
export const collections = {
  ...
  landings: defineCollection({
    loader: file('src/data/landings.json'),
    schema: restaurantCollections.landings,
  }),
  neighborhoods: defineCollection({
    loader: file('src/data/neighborhoods.json'),
    schema: restaurantCollections.neighborhoods,
  }),
};
